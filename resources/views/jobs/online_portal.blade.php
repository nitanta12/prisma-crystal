                 ...
                 <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$key + 1}}</td>
                                <td><input type="text" value="{{$oj->portal_name}}" class="form-control main_update" name="portal_name"></td>
                                <td><input type="text" value="{{$oj->category}}" class="form-control main_update" name="category"></td>
                                <td><input type="number" value="{{$oj->cost_per_month}}" class="form-control main_update cost_per_month_u" step="0.01" name="cost_per_month"></td>
                                <td><input type="number" value="{{$oj->duration}}" class="form-control main_update duration_u" step="0.01" name="duration"></td>
                                <td><input type="number" value="{{$oj->total_amount}}" class="form-control main_update total_amount_u" step="0.01" name="total_amount" readonly></td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <input type="hidden" name="table_name" value="online_portal">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="number" name="cost_per_month" class="form-control cost_per_month" step="0.01">
            </div>
             <div class="form-group">
                <label>Duration</label>
                <input type="number" name="duration" class="form-control duration" step="0.01">
            </div>
             <div class="form-group">
...
$(function()
{
    ...
    {   
      ...
      if(status)
      {
        ...
        $.ajax({
               type:'POST',
               url:'/admin/job_estimate/jobs/delete/'+ oid + '/online_portal' ,
    ...
    $(document).on('click','.update_now',function()
    {
         ...
         $(z).parents('tr').find('input.main_update').each(function(index,item)
         {
          ...
          $.ajax({
               type:'POST',
               url:'/admin/job_estimate/jobs/update/'+ oid + '/online_portal' ,
