              ...
              <tbody>
                ...
                @foreach($jobs as $key=>$oj)
                  ...
                  <tr>
                    ...
                    <td>{{$oj->program}}</td>
                    <td>{{$oj->position}}</td>
                    <td>@if($oj->is_sponsorship == 'yes')
                                  Sponsorship
                                  @else
                                  {{$oj->rate_type}}
                                  @endif</td>
                    <td>
                      @if($oj->rate_type == 'rate_per_minute')
                        {{$oj->rate_per_minute}}
                      @endif
                       @if($oj->rate_type == 'rate_per_spot')
                        {{$oj->rate_per_spot}}
                      @endif
                       @if($oj->rate_type == 'rate_per_day')
                        {{$oj->rate_per_day}}
                      @endif
      ...
      <table class="table table-bordered border-table">
        <tbody>
          @foreach($jobs as $key=>$oj)
            ...
            <tr>
              <td>{{$oj->television}} (Television)</td>
              <td>
                @if($oj->rate_type == 'rate_per_minute')
                {{$oj->rate_per_minute}} 
                  @php
                    $rate_after_discount =$oj->rate_per_minute;
                  @endphp
                @endif
                 @if($oj->rate_type == 'rate_per_spot')
                {{$oj->rate_per_spot}} 
                  @php
                    $rate_after_discount =$oj->rate_per_spot;
                  @endphp
                @endif
                 @if($oj->rate_type == 'rate_per_day')
                {{$oj->rate_per_day}} 
                  @php
                    $rate_after_discount =$oj->rate_per_day;
                  @endphp
                @endif

                @if($oj->is_sponsorship == 'yes')
                @php
