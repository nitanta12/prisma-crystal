                                ...
                                <td>
                                    <div>
                                      ...
                                      <a class="btn btn-success btn-xs" style="color:#fff" data-toggle="modal" data-target="#discountmodal{{$key}}"><i class="fa fa-money"></i> Discount</a>
                                        ...
                                        <input type="hidden" name="table_name" value="tv">
                                      ...
                                      <!-- Discount ends -->
                                        ...
                                        <form action="{{URL::TO('/')}}/admin/jobs/update_tv_radio/tv" method="post">
                                          <!-- The Modal -->
                                              ...
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                      ...
                                                      <div class="append_rates_type">
                                                          <div class="form-group rate_per_minute" style="display: none"><label>Rate Per Minute</label><input type="number" name="rate_per_minute" class="form-control" step="0.01" value="{{$pm->rate_per_minute}}"></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
              <label>Is Sponsorship?</label>
                <input type="checkbox" name="is_sponsorship" value="no" class="is_sponsorship">
...
{   
    ...
    {   
      ...
      if(status)
      {
        ...
        $.ajax({
               type:'POST',
               url:'/admin/job_estimate/jobs/delete/'+ oid + '/tv' ,
    ...
    $(document).on('click','.update_now',function()
    {
         ...
         $(z).parents('tr').find('input.main_update').each(function(index,item)
         {
          ...
          $.ajax({
               type:'POST',
               url:'/admin/job_estimate/jobs/update/'+ oid + '/tv' ,
