...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
    <header class="app-header navbar">
        ...
        <a class="navbar-brand" href="#">
            <span class="navbar-brand-full">PRISMA</span>
    ...
    <div class="app-body">
        ...
        @elseif(auth()->user()->roles[0]->title == 'CS')
           @include('partials.csmenu')
        @elseif(auth()->user()->roles[0]->title == 'Accounts')
           @include('partials.accountmenu')
        @elseif(auth()->user()->roles[0]->title == 'Traffic')
           @include('partials.trafficmenu')
        @elseif(auth()->user()->roles[0]->title == 'Creative')
           @include('partials.creativemenu')
        @elseif(auth()->user()->roles[0]->title == 'Executive')
           @include('partials.Executivemenu')
        @endif
        <main class="main">
