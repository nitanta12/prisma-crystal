            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                @foreach($jobs as $key=>$oj)
                  ...
                  <tr>
                    <td>{{$key + 1}}</td>
                    <td>{{$oj->movie_theatre}}</td>
                    <td>{{$oj->auditorium}}</td>
                    <td>{{$oj->total_show}}</td>
                    <td>{{$oj->seat_capacity}}</td>
                    <td>{{$oj->weekend_occ}}</td>
                    <td>{{$oj->weekday_occ}}</td>
                    <td>{{$oj->duration}}</td>
                    <td>{{$oj->position}}</td>
                    <td>{{$oj->rate_per_month}}</td>
                  </tr>
      ...
      <table class="table table-bordered border-table">
        <tbody>
          @foreach($jobs as $key=>$oj)
            ...
            <tr>
              <td>{{$oj->movie_theatre}} (Movie Theatre)</td>
              <td>{{$oj->rate_per_month}} (Actual Rate)</td>
              @php
                
                $rate_after_discount =$oj->rate_per_month;
              @endphp
              @foreach($oj->discounts as $ojd)
                @php
